...
addLayer("S", {
    name: "Saturation", // This is optional, only used in a few places, If absent it just uses the layer id.
...
addLayer("B", {
    name: "Brightness", // This is optional, only used in a few places, If absent it just uses the layer id.
